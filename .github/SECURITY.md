...
<https://github.com/andreygrechin/gcphelper/releases>.

## Reporting a Vulnerability

To report a security vulnerability, please use Private vulnerability reporting at
<https://github.com/andreygrechin/gcphelper/security/>. This submission will only be viewable by
repository maintainers. You will be credited if the advisory is published.

If the above options aren't suitable, create
[a GitHub issue](https://github.com/andreygrechin/gcphelper/issues) with minimal details, avoiding
